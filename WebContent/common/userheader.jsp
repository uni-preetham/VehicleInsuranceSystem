...
header {
	background-color: rgba(20, 164, 77, 1);
	border-radius: 30px;
}
    </style>
</head>
...
<header
	...
	<div class="navbar-nav">
		<a class="nav-item nav-link h6 text-white" href="<%=request.getContextPath()%>/home/home.jsp">Home</a> <a
			class="nav-item nav-link h6 text-white"
			href="<%=request.getContextPath()%>/products/products.jsp">Our Policies</a>
	...
	<div>
		<a href="<%=request.getContextPath()%>/logout"
			class="btn btn-light font-weight-bold">Logout</a>
	</div>
	</header>
